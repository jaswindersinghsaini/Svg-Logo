...
describe('Shapes', () => {
    ...
    describe ('Triangle', () => {
        it('should pass the render function equalling triangle properties', () => {
            ...
            shape.setColor("red");
            expect(shape.render()).toEqual(`<polygon width ="300" height ="200" points="150, 18 244, 182 56, 182" fill="${this.color}" />`);
    ...
    describe ('Square', () => {
        it('should pass the render function equalling square properties', () => {
            ...
            shape.setColor("blue");
            expect(shape.render()).toEqual(`<rect width ="300" height ="300"  fill="${this.color}" />`);
